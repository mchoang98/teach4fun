# Bài 12-2: PEP 8 trong Python
# BÀI 11-2: PEP 8 – Quy tắc viết mã Python chuẩn

## Khung học vui

**Bối cảnh:** Bạn không chỉ viết code chạy được, bạn viết code để một tuần sau chính mình đọc lại vẫn hiểu. Clean code là cách làm bài tập trông chuyên nghiệp hơn.

**Thử ngay trong 5 phút:** Đổi tên 3 biến khó hiểu trong một đoạn code thành tên rõ nghĩa, rồi căn lại khoảng trắng theo PEP 8.

**Hoạt động cặp đôi:** Hai bạn review code cho nhau: khoanh vùng tên biến mơ hồ, dòng quá dài, và đoạn lặp có thể tách thành hàm.

**Nâng cấp sau giờ học:** Refactor một bài cũ: tách hàm, đổi tên biến, thêm comment ngắn ở nơi thật sự cần.
